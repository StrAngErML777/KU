...
import com.example.finalproject.bean.UserInfo;
import com.example.finalproject.database.UserDBHelper;
import com.example.finalproject.util.DateUtil;
import com.example.finalproject.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "教师用户", "18990040 莫骆帅奇"};
