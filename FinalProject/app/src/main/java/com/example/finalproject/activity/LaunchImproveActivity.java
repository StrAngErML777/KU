...
import com.example.finalproject.adapter.LaunchImproveAdapter;

public class LaunchImproveActivity extends AppCompatActivity {
    // 声明引导页面的图片数组
    private int[] lanuchImageArray = {R.drawable.iphone12pro,
            R.drawable.mi10, R.drawable.huaweimate40pro, R.drawable.huaweip40pro, R.drawable.redmik30pro};
