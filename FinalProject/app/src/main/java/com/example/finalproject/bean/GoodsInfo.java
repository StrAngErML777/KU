...
public class GoodsInfo {
    ...
    private static int[] mThumbArray = {
            R.drawable.iphone12_s,
            R.drawable.iphone12pro_s,
            R.drawable.mi10_s,
            R.drawable.mi10qingchunban_s,
            R.drawable.mi10zhizunjinianban_s,
            R.drawable.redmik30pro_s,
            R.drawable.huaweimate40pro_s,
            R.drawable.huaweip40pro_s
    };
    // 声明一个手机商品的大图数组
    private static int[] mPicArray = {
            ...
            R.drawable.mi10,
            R.drawable.mi10qingchunban,
            R.drawable.mi10zhizunjinianban,
            R.drawable.redmik30pro,
            R.drawable.huaweimate40pro,
            R.drawable.huaweip40pro
    };
